read_verilog rtl.v
synth_design -top top -flatten_hierarchy none -gated_clock_conversion off -bufg 10 -directive AlternateRoutability -fsm_extraction sequential -resource_sharing on
