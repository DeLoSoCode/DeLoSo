read_verilog rtl.v
synth_design -top top -flatten_hierarchy none -bufg 6 -directive AlternateRoutability -fsm_extraction auto -resource_sharing auto -control_set_opt_threshold 1 -shreg_min_size 8 -max_bram_cascade_height -1 -max_uram_cascade_height -1 -cascade_dsp force -incremental_mode aggressive -retiming -no_lc
