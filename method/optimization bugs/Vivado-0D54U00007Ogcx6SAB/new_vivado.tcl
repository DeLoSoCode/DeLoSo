read_verilog rtl.v
synth_design -top top -flatten_hierarchy rebuilt -directive AreaOptimized_medium -fsm_extraction gray -resource_sharing off -control_set_opt_threshold 10 -shreg_min_size 10 -max_bram -1 -max_uram -1 -cascade_dsp force -incremental_mode aggressive -retiming -no_srlextract
