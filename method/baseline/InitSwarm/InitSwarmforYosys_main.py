...
from InitSwarmforYosys import main
import subprocess
import time
...
synth_directory_path = "/home/baseline/InitSwarm/synth"
...
wrong_directory_path="/home/baseline/InitSwarm/Wrong_case"
...
check_directory_path="/home/baseline/InitSwarm/check"
...
for filename in files:
    ...
    for i in range(len_result):        
        ...
        yosys_command = f'yosys -p "read_verilog rtl.v; hierarchy; {new_result} write_verilog new_syn_yosys.v"> output.txt 2>%1'
